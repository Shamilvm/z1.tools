...
const YoutubeOptimizer: React.FC = () => {
  const [input, setInput] = useState('');
  const output = input
    ? `Title ideas:\n1. ${input} - Complete Guide\n2. ${input} Tips for Beginners\n3. ${input}: Mistakes to Avoid\n\nDescription:\nLearn ${input} in this video.\n\nTags:\n#${input.replace(/\s+/g, '')} #tutorial #tips`
    : 'Awaiting input to generate...';

  return (
    <ToolLayout title="YouTube Optimizer" description="Title/Description Generator" icon={<Globe size={24} />}> 
