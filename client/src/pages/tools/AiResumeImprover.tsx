...
const AiResumeImprover: React.FC = () => {
  const [input, setInput] = useState('');

  return (
    <ToolLayout title="AI Resume Bullet" description="Upgrade your ATS tool" icon={<FileText size={24} />}> 
...
export default AiResumeImprover;