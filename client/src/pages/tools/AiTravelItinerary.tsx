...
const AiTravelItinerary: React.FC = () => {
  const [input, setInput] = useState('');

  return (
    <ToolLayout title="AI Travel Itinerary" description="Fits your travel domain" icon={<Plane size={24} />}> 
...
export default AiTravelItinerary;